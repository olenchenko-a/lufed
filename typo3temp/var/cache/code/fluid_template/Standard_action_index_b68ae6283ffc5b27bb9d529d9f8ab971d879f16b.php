...
class Standard_action_index_b68ae6283ffc5b27bb9d529d9f8ab971d879f16b extends \TYPO3Fluid\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
$output0 .= '<form action="" id="ConfigurationView" method="post">
	<h1>';
...
$array5 = array (
);$arguments3['key'] = $renderingContext->getVariableProvider()->getByPath('treeName', $array5);
...
$output0 .= '
			...
			<input class="form-control" type="search" id="lowlevel-searchString" name="searchString" value="';
$array8 = array (
);
$output0 .= call_user_func_array( function ($var) { return (is_string($var) || (is_object($var) && method_exists($var, '__toString')) ? htmlspecialchars((string) $var, ENT_QUOTES) : $var); }, [$renderingContext->getVariableProvider()->getByPath('searchString', $array8)]);
...
$array11 = array();
$array12 = array (
);$array11['0'] = call_user_func_array( function ($var) { return (is_string($var) || (is_object($var) && method_exists($var, '__toString')) ? htmlspecialchars((string) $var, ENT_QUOTES) : $var); }, [$renderingContext->getVariableProvider()->getByPath('regexSearch', $array12)]);
...
$array20 = array (
);return $renderingContext->getVariableProvider()->getByPath('tree', $array20);
};
$arguments18 = array();
